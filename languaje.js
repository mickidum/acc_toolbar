{
  ...
  "es": {
    "btn_open": "menu de accesibilidad",
    "btn_close": "cerrar",
    "keyboard_root": "tecaldo de navigacion",
    "disable_animattions": "quitar animacion",
    "access_declaration": "accesibilidad statement",
    "debug_contacts": "reportar problema de accesibilidad",
    "reset_all_settings": "reiniciar ajustes",
    "image_without_alt": "imagenes sin texto",
    "contrast_block": {
      "header": "color contraste",
      "btn_monochrome": "sin color<br>mostrar",
      "btn_bright": "brillo<br>contraste",
      "btn_invert": "invertir<br>colores"
    },
    "text_block": {
      "header": "tamano del texto",
      "btn_font_up": "aumentar<br>texto",
      "btn_font_down": "disminuir<br>texto",
      "btn_font_readable": "legible<br>texto"
    },
    "content_block": {
      "header": "destacar contenido",
      "btn_underline_links": "subrayar<br>links",
      "btn_underline_headers": "subrayar<br>encabezados",
      "btn_images_titles": "imageness<br>titulos"
    },
    "zoom_block": {
      "header": "aumentar",
      "btn_cursor_white": "grande blanco<br>cursor",
      "btn_cursor_black": "grande negro<br>cursor",
      "btn_zoom_in": "aumentar<br>pantalla"
    }
